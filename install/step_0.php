...
<div class="main">
  <div class="text-box" id="text-box">
    <div class="license">
      <h1>商城V5 安装协议</h1>
      <p>感谢你选择商城V5，本系统由商城根据网域天创网络流传的版本所改进版本，系统版权归属于软件开发商，只用于学习研究交流使用。</p>
      <p>
用户须知：本协议是您与商城之间关于您安装使用商城33hao.com提供的商城V5版电商系统及服务的法律协议。无论您是个人组织、盈利与否、用途如何（包括以学习和研究为目的），均与商城无关！商城只提供相关技术服务！不负责任何商业责任！还请知悉。</p>
      <p></p>
      <p align="right">商城网店技术交流中心</p>
    </div>
  </div>
